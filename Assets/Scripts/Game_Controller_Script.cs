...
public class Game_Controller_Script : MonoBehaviour
{
    ...
    [Header("Menu")]
    [SerializeField] private Menu_Controller_Script Menus_Controller;
    ...
    public void Button_Hit(Base_Players_Script vez)
    {
        if (
            Player.Pontos < 21 &&
            Stand == false &&
            Menus_Controller.Status_Pause == false &&
            cont < 3
          )
        {
    ...
    {
        if (Player.Pontos < 21 && Stand == false && Menus_Controller.Status_Pause == false)
        {
    ...
    {
        if (Menus_Controller.Status_Pause == false)
        {
            Stand = false;
            cont = 0;
